...
The Maestro Bitcoin Go library provides convenient access to [the Maestro Dapp Platform REST
...
```sh
go get -u 'github.com/maestro-org/maestro-bitcoin-go-sdk@v0.1.0-alpha.4'
```
